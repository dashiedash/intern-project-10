  ...
  <main class="m-3 p-3 max-w-md mx-auto">
    ...
    <div class=" container p-4">
      ...
      <div class="bg-[#eaedde] p-7 my-3 flex justify-center rounded-xl">
        <form class="mb-4" method="POST" action="create.php" class="">
          ...
          <label for="item_name" class="block mb-1 font-bold">Item Name:</label>
          <input type="text" id="item-name" name="item-name" class="w-full p-2 mb-4">

          <label for="stock_amount" class="block mb-1 font-bold">Stock Amount:</label>
